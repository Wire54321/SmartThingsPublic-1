...
def getButtonSections(buttonNumber) {
	return {
        ...
        section("Buttons") {
			input "buttons_${buttonNumber}_pushed", "capability.button", title: "Pushed", multiple: true, required: false
			input "buttons_${buttonNumber}_held", "capability.button", title: "Held", multiple: true, required: false
		}
		section("Locks") {
