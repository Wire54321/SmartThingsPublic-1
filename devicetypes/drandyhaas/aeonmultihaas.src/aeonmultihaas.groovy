 ...
 */
metadata {
	definition (name: "AeonMultiHaas", namespace: "drandyhaas", author: "Andrew Haas") {
...
def parse(String description)
{
    ...
    //can turn on to check it's working
    /*
...
def configure() {
	log.debug "get and configure..."
	delayBetween([
    
    //   http://aeotec.com/z-wave-sensor/1323-multisensor-guide.html
    /*
    ...
    */
		...
		//zwave.configurationV1.configurationSet(parameterNumber: 4, size: 2, scaledConfigurationValue: 1).format(),

		// send all data (temperature, humidity, illuminance, and battery) periodically
		...
		// set data reporting period to this many seconds
