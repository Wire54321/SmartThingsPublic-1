...
metadata {
	definition (name: "Z-Wave Door/Window Sensor Haas", namespace: "drandyhaas", author: "SmartThings and Andy Haas") {
...
{
	def event = createEvent(descriptionText: "${device.displayName} woke update", isStateChange: false)
	def cmds = []
	if (!state.MSR) {
