 ...
 */
metadata {
	definition (name: "AeonOutletHaas", namespace: "drandyhaas", author: "Andrew Haas") {
...
def parse(String description) {
	...
	if (!device.currentValue("updated")) sendEvent(name:"updated", value: 1)
    //else sendEvent(name:"updated", value: device.currentValue("updated")+1)//ACH
